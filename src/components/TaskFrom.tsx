...
export const TaskForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="md-5 text-center">
      ...
      <p className='mb-3 text-pink-500'>
        {createTaskMutation.error?.data?.zodError && createTaskMutation.error.zodError.fieldErrors.title}
      </p>
      <textarea
        className='mb-3 border border-gray-300 px-3 py-2'
        placeholder='Body'
      ...
      />
      <p className='mb-3 text-pink-500'>
        {createTaskMutation.error?.data?.zodError && createTaskMutation.error.zodError.fieldErrors.body}
      </p>
